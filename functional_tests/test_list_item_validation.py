...
class ItemValidationTest(FunctionalTest):
    ...
    def test_error_messages_are_cleared_on_input(self):
        # Dancer starts a list and causes a validation error:
    ...
    def test_error_messages_are_cleared_when_input_box_clicked(self):
        # Dancer starts a list and causes a validation error:
        self.browser.get(self.live_server_url)
        ...
        # He clicks into the input box to clear the error
        self.get_item_input_box().click()
        
        # Upon clicking, he discovers the error message has vanished!
        self.wait_for(lambda: self.assertFalse(
            self.get_error_element().is_displayed()
        ))
    ...
    def test_cannot_add_duplicate_items(self):
        ...
        # Dancer goes to the home page and starts a new list
        self.browser.get(self.live_server_url)
